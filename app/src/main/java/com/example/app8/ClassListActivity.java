        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
              public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String[] option = {"Photo", "Camera"};
                AlertDialog.Builder builder = new AlertDialog.Builder(context);
                builder.setTitle("Attendance by:");
                builder.setItems(option, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int which) {
                        String selectedOption = option[which];
                        if (selectedOption.equals("Photo")){
                            Intent intent = new Intent(ClassListActivity.this, PhotoAttendActivity.class);
                            startActivity(intent);
                        } else if (selectedOption.equals("Camera")){
                            Intent intent =  new Intent(ClassListActivity.this, CameraAttendActivity.class);
                            startActivity(intent);
                        }
                    }
                });
...
//            }
        ...
        expandable_navigation.init(this)
                ...
                .addHeaderModel(new HeaderModel("Export List"))
                .addHeaderModel(new HeaderModel("Setting"))
                ...
                .addOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
                    ...
                    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                        ...
                        if (id == 0) {
                            ...
                            //Recognize Menu
                            Common.showToast(context, "Export List");
                            Intent intent = new Intent(v.getContext(), CalenderActivity.class);
                            startActivity(intent);
                            drawer.closeDrawer(GravityCompat.START);
                        } else if (id == 2) {
                            //Setting Account
                            Common.showToast(context, "Setting Account Selected");
...
//            }
    ...
    private void loadAccountData() {
        ...
        String query = "SELECT [id], [name_class], [name_subject], [teacher], [background] FROM [PROJECT].[dbo].[CLASS]";
